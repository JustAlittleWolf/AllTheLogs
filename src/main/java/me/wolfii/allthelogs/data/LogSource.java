 ...
 */
public sealed interface LogSource extends me.wolfii.allthelogs.api.LogSource
    permits LogSource.File, LogSource.Archive, LogSource.Session {
    /**
     ...
     */
    record File(Path path) implements LogSource, me.wolfii.allthelogs.api.LogSource.File {
        public File {
     ...
     *                  separated by {@code !/}
     */
    record Archive(Path path, String entryPath) implements LogSource, me.wolfii.allthelogs.api.LogSource.Archive {
        public Archive {
            Objects.requireNonNull(path, "path");
    ...
    /**
     * Captured from a running Minecraft client with {@link LogStore#startSession(String, String)}. A session is not a file,
     ...
     *           {@link LogStore#startSession(String, String)} always assigns one
     */
    record Session(String id) implements LogSource, me.wolfii.allthelogs.api.LogSource.Session {
    }
}
