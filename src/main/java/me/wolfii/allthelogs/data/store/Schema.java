...
public final class Schema {
     ...
     * <p>
     * On-disk compact is only worth it after dropping a <em>previous</em> clustered copy. A first
     * cluster of an unsorted import already builds a packed table; skipping the catalog copy is
     * what keeps a 370-file import from sitting on {@code n/n} while DuckDB rewrites the file.
     *
