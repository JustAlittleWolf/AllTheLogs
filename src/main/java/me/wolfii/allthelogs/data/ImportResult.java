 ...
 * @param skippedFiles     number of candidate files that were not stored, because they were already imported, belonged
 *                         to a live session already stored, had no usable timestamps, or had no chat content and no
 *                         {@code Reloading ResourceManager} line
...
public record ImportResult(
    ...
    /**
     * @param path   the path of the file that failed; for archives this is {@link LogSource.Archive#entryPath()}
